...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/foreign1.css?ver=12">
<style type="text/css">
...
<body>
	...
	<div class="foreign_contents">
		...
		<!-- <img class="info_map"> -->
		<div class="info_text">
			<font style="font-weight: bold;">입국 관리</font><br>${Arr }<br>
			<font style="font-weight: bold;">격리 조치</font><br>${Exp }<br>
